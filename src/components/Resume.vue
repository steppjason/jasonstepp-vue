<template>
	<div class="email">
		<svg class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
			<g>
		...
		<router-link to="@assets/files/Jason-Stepp-Resume-01132022">Resume</router-link>
	</div>
</template>
